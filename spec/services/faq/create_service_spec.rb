  ...
  describe '#call' do
    context 'Without hashtag params' do
      it 'will receive a error' do
        @create_service = FaqModule::CreateService.new('question' => @question, 'answer' => @answer)
    ...
    context 'With Valid params' do
      before do
        @create_service = FaqModule::CreateService.new('question' => @question, 'answer' => @answer, 'hashtags' => @hashtags)
        @response = @create_service.call
      end
